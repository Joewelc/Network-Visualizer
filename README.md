A Python network visualizer you can use to see, creates an arp table that shows current IPs and correlated mac addresses of devices connected to your network.
